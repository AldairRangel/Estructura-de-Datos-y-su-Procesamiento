...
while True:
    ...
    #Existiendo ya las calificaciones, procede a describir con ayuda de la estadistica como fueron las notas de cada materia
        ...
        while True:
            print("Las estadisticas arrojadas según nuestras materias son las siguiente:")
            materia = calificaciones.describe()
            print(materia)
            m = materia
            print("*" * 40)
            print("Las estadisticas arrojadas por cada una de nuestros maestros, son las siguientes:")
    ...
    #Muestra las claves de alumnos que tienen 2 o más materias reprobadas
        ...
        while True:
            ...
            for x in reprobados:
                cal = reprobados.get(x)
                if cal > 1:
                    print(f"El alumno con clave {x} reprobo {cal} materias.")
            break    
